import { Alert, AlertTitle, Button, Card, CardActions, CardContent, FormControl, Grid, InputLabel, MenuItem, Select, TextField, Typography } from "@mui/material";
    ...
    return (
        user.status_emp == 3 ?
            <Grid justify="center"
                ...
                <Grid item sx={12}>
                        <br/>
                        <h3><strong>נראה כי אתה מחפש עבודה</strong></h3>
                        לעובדים פנויים אין אפשרות לשנות סטטוס
                        <br />
                        <br /><br /><Button size="small" style={{ background: '#006064' }} variant="contained" size="large" onClick={() => { window.location.assign(`/employee-bar/`) }}>
                        חזרה לדף הבית
                        </Button>
